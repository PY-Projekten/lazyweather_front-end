  ...
  <div>
    ...
    <form @submit.prevent="submitForm">
      <div>
       ...
       <!--  <v-select :options="locationsList" v-model="location" placeholder="Select or type a location"></v-select> -->
...
/*   components: {
  ...
  data() {
    return {
      location: '',
      date: new Date().toISOString().substr(0, 10), // Set default date to current date
      hour: '',
